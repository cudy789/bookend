...
urlpatterns = [
    ...
    path('library/book/data/book_isbn_images/<str:filename>', book_isbn, name="bookISBN"),
    path('users/data/card_id_images/<str:filename>', user_card_image, name="userCardImage"),
